...
const options = [
  { value: 1, label: "Manual de cuidado de Casas" },
  { value: 2, label: "Manual de cuidado de Departamentos" },
];
...
const Banner = (props) => {
  ...
  return (
    <>
      <div className="hidden w-1/3 justify-end px-4 pb-4 sm:flex md:h-80 xl:h-48">
        <div className="border px-6 py-6 shadow-xl">
          <div className="px-4 py-4">
            <a
              href="/clientes/manuales-de-compra/manual-cuidado-casas?val=1"
          ...
          <div className="px-4 py-2">
            <a
              href="/clientes/manuales-de-compra/manual-cuidado-departamentos?val=2"
