...
const CustomCards = (props) => {
  ...
  return (
    <div className="relative flex h-[400px] w-[300px] flex-shrink-0 md:h-[500px] md:w-[300px]">
      ...
      <a
        href={`/${props.paginaDetalle}/${props.nombreProyectoUrl}?val=${props.idProyecto}`}
      >
        {props.imagen && (
          <picture>
            {/* Imagen de fondo para dispositivos pequeños */}
            <source src={proyecto.imagenMiniatura} media="(max-width: 640px)" />
            {/* Imagen de fondo para dispositivos grandes */}
            <source src={proyecto.imagenMiniatura} media="(min-width: 641px)" />
          ...
          <div className="h-1/3 w-full">
            ...
            <ul className="text-white">
              <li className="flex items-center">
                ...
                <div className="ml-2">
                  Desde UF {formatoNumero(proyecto.ufMinimo)}
                </div>
              </li>
