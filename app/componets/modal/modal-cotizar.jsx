        ...
        <div className="px-4 py-2">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-3 gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col">
              ...
              <input type="text" id="nombre" name="nombre" className="border border-gray-300 rounded px-4 py-2 w-full" />
            </div>
            <div className="flex flex-col">
              <label htmlFor="rut_cliente" className="mb-1 text-left">Rut:</label>
              <input type="text" id="rut_cliente" name="rut_cliente" className="border border-gray-300 rounded px-4 py-2 w-full" />
            </div>
            <div className="flex flex-col">
